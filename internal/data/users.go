...
func (m UserModel) GetForToken(tokenScope, TokenPlaintext string) (*User, error) {
	...
	// to get a slice containing the token hash, rather than passing in the array (which // is not supported by the pq driver), and that we pass the current time as the
