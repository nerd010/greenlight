...
func (m Mailer) Send(recipient, templateFile string, data interface{}) error {
	...
	// headers, the SetBody() method to set the plain-text body, and the AddAlternative() // method to set the HTML body. It's important to note that AddAlternative() should
